...
(
    {
        ...
        USERS: '/api/v1/users',
        ME: '/api/v1/users/me',
        PASSKEYS: '/api/v1/auth/fido2/passkeys',
        PASSKEYS_REGISTER: '/api/v1/auth/fido2/passkeys/register',
        PASSKEYS_LOGIN: '/api/v1/auth/fido2/passkeys/login',
        PASSKEYS_LOGIN_VERIFICATION: '/api/v1/auth/fido2/passkeys/login/verify',
...
(
    {
        ...
        DEFAULT_PBKDF2_ITERATION_COUNT: (1024 * 64),
