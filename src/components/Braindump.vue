    ...
    response.json().then(async responseBodyEnvelope =>
    {
      ...
      if (encryptedAesKeyGuid)
      {
        try
        {
          ...
          aesKey = await aes.decryptString(aesKeyDataEntryResponseDto.Items[0].Data, localStorage.getItem(LocalStorageKeys.PASSWORD_HASH) ?? '');
        ...
        (
            `${config.BackendBaseURL}${EndpointURLs.DATA_ENTRIES}`,
            {
              ...
              body: JSON.stringify({
                ...
                Notes: 'Automatically generated by Braindump. DO NOT DELETE OR MODIFY!',
